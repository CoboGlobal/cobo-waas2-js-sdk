...
export default class StakingsApi {
    ...
    */
     ...
     */
    getStakingActivityByIdWithHttpInfo(activityId) {
      let postBody = null;
      // verify the required parameter 'activityId' is set
      if (activityId === undefined || activityId === null) {
        throw new Error("Missing the required parameter 'activityId' when calling getStakingActivityById");
      }
     ...
     */
    getStakingActivityById(activityId) {
      return this.getStakingActivityByIdWithHttpInfo(activityId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
