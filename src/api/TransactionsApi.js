...
export default class TransactionsApi {
    ...
    */
     ...
     * @param {String} chain_id The chain ID, which is the unique identifier of a blockchain. You can retrieve the IDs of all the chains you can use by calling [List enabled chains](https://www.cobo.com/developers/v2/api-references/wallets/list-enabled-chains).  This operation currently supports the following chains only: - `ETH`: Ethereum mainnet. - `SETH`: Ethereum Sepolia testnet. 
     * @param {String} tx_hash The transaction hash, which is the unique identifier of a transaction on the blockchain. You can retrieve the transaction hash of a transaction by calling [Get transaction information](https://www.cobo.com/developers/v2/api-references/transactions/get-transaction-information).  You need to specify the hash with the `0x` prefix. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TransactionReceipt} and HTTP response
     */
    getTransactionReceiptWithHttpInfo(chain_id, tx_hash) {
      let postBody = null;
      if (postBody && postBody.toJSON) {
          postBody = postBody.toJSON()
      }
      ...
      if (chain_id === undefined || chain_id === null) {
        throw new Error("Missing the required parameter 'chain_id' when calling getTransactionReceipt");
      }
      // verify the required parameter 'tx_hash' is set
      if (tx_hash === undefined || tx_hash === null) {
        throw new Error("Missing the required parameter 'tx_hash' when calling getTransactionReceipt");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = TransactionReceipt;
      return this.apiClient.callApi(
        '/transactions/chains/{chain_id}/tx_hash/{tx_hash}/receipt', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @param {String} chain_id The chain ID, which is the unique identifier of a blockchain. You can retrieve the IDs of all the chains you can use by calling [List enabled chains](https://www.cobo.com/developers/v2/api-references/wallets/list-enabled-chains).  This operation currently supports the following chains only: - `ETH`: Ethereum mainnet. - `SETH`: Ethereum Sepolia testnet. 
     * @param {String} tx_hash The transaction hash, which is the unique identifier of a transaction on the blockchain. You can retrieve the transaction hash of a transaction by calling [Get transaction information](https://www.cobo.com/developers/v2/api-references/transactions/get-transaction-information).  You need to specify the hash with the `0x` prefix. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TransactionReceipt}
     */
    getTransactionReceipt(chain_id, tx_hash) {
      return this.getTransactionReceiptWithHttpInfo(chain_id, tx_hash)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
