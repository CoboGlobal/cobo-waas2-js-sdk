...
export default class FeeStationApi {
    ...
    */
     ...
     */
    listFeeStationFiatTransactionsWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
      if (postBody && postBody.toJSON) {
          postBody = postBody.toJSON()
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ListFeeStationFiatTransactions200Response;
      return this.apiClient.callApi(
        '/fee_station/fiat_transactions', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     */
    listFeeStationFiatTransactions(opts) {
      return this.listFeeStationFiatTransactionsWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
