 ...
 */
class CancelSatoshiTestChallengeRequest {
    /**
     ...
     */
    static initialize(obj, challenge_id) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of CancelSatoshiTestChallengeRequest.RequiredProperties) {
...
export default CancelSatoshiTestChallengeRequest;
