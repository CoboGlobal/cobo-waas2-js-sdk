 ...
 */
class TokenizationWeb3OperationSource {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of TokenizationWeb3OperationSource.RequiredProperties) {
...
export default TokenizationWeb3OperationSource;
