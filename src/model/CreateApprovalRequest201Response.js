 ...
 */
class CreateApprovalRequest201Response {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateApprovalRequest201Response.RequiredProperties) {
...
export default CreateApprovalRequest201Response;
