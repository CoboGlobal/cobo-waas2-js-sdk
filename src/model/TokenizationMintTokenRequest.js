...
/**
 * The TokenizationMintTokenRequest model module.
 * @module model/TokenizationMintTokenRequest
 */
class TokenizationMintTokenRequest {
    /**
     * Constructs a new <code>TokenizationMintTokenRequest</code>.
     * @alias module:model/TokenizationMintTokenRequest
     ...
     */
    constructor(source, mints, fee) { 
        TokenizationMintTokenParams.initialize(this, source, mints);TokenizationAppInitiator.initialize(this);
        TokenizationMintTokenRequest.initialize(this, source, mints, fee);
    }
     ...
     */
    static initialize(obj, source, mints, fee) { 
        obj['source'] = source;
        obj['mints'] = mints;
        obj['fee'] = fee;
    }
    ...
    /**
     * Constructs a <code>TokenizationMintTokenRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TokenizationMintTokenRequest} obj Optional instance to populate.
     * @return {module:model/TokenizationMintTokenRequest} The populated <code>TokenizationMintTokenRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TokenizationMintTokenRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>TokenizationMintTokenRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TokenizationMintTokenRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TokenizationMintTokenRequest.RequiredProperties) {
...
TokenizationMintTokenRequest.RequiredProperties = ["source", "mints", "fee"];

/**
 * @member {module:model/TokenizationTokenOperationSource} source
 */
TokenizationMintTokenRequest.prototype['source'] = undefined;
 ...
 */
TokenizationMintTokenRequest.prototype['mints'] = undefined;
 ...
 */
TokenizationMintTokenRequest.prototype['app_initiator'] = undefined;
...
export default TokenizationMintTokenRequest;
