...
class TransactionTransferToWalletDestination {
     ...
     */
    constructor(destinationType, walletId, amount) { 
        
        TransactionTransferToWalletDestination.initialize(this, destinationType, walletId, amount);
    }
     ...
     */
    static initialize(obj, destinationType, walletId, amount) { 
