...
class EvmLegacyTransactionFee {
     ...
     */
    constructor(gas_price, gas_limit, fee_type, token_id) { 
        EvmLegacyFeeBasePrice.initialize(this, gas_price);FeeData.initialize(this, gas_limit);
        EvmLegacyTransactionFee.initialize(this, gas_price, gas_limit, fee_type, token_id);
    }
     ...
     */
    static initialize(obj, gas_price, gas_limit, fee_type, token_id) { 
