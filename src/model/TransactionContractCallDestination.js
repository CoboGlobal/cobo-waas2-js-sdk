...
class TransactionContractCallDestination {
     ...
     */
    constructor(destinationType, address, value, calldata) { 
        
        TransactionContractCallDestination.initialize(this, destinationType, address, value, calldata);
    }
     ...
     */
    static initialize(obj, destinationType, address, value, calldata) { 
