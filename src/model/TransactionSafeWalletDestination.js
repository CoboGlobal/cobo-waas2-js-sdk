...
class TransactionSafeWalletDestination {
    /**
     * Constructs a new <code>TransactionSafeWalletDestination</code>.
     ...
     */
    constructor(destination_type, wallet_id, token_id, address, amount) { 
        
        TransactionSafeWalletDestination.initialize(this, destination_type, wallet_id, token_id, address, amount);
    }
     ...
     */
    static initialize(obj, destination_type, wallet_id, token_id, address, amount) { 
    ...
    /**
     * Constructs a <code>TransactionSafeWalletDestination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransactionSafeWalletDestination} obj Optional instance to populate.
     * @return {module:model/TransactionSafeWalletDestination} The populated <code>TransactionSafeWalletDestination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransactionSafeWalletDestination();
    ...
    /**
     * Validates the JSON data with respect to <code>TransactionSafeWalletDestination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransactionSafeWalletDestination</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransactionSafeWalletDestination.RequiredProperties) {
...
TransactionSafeWalletDestination.RequiredProperties = ["destination_type", "wallet_id", "token_id", "address", "amount"];

/**
 * @member {module:model/TransactionDestinationType} destination_type
 */
TransactionSafeWalletDestination.prototype['destination_type'] = undefined;
 ...
 */
TransactionSafeWalletDestination.prototype['asset_id'] = undefined;

/**
 * The destination address.
 * @member {String} address
 */
TransactionSafeWalletDestination.prototype['address'] = undefined;
 ...
 * @member {String} memo
 */
TransactionSafeWalletDestination.prototype['memo'] = undefined;

/**
 * The transaction amount. For example, if you trade 1.5 ETH, then the amount is `1.5`. 
 * @member {String} amount
 */
TransactionSafeWalletDestination.prototype['amount'] = undefined;
...
export default TransactionSafeWalletDestination;
