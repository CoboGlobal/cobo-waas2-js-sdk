...
import BaseStakeSource from './BaseStakeSource';
...
class MpcStakeSource {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            BaseStakeSource.constructFromObject(data, obj);
    ...
    static validateJSON(data) {
        ...
        for (const property of MpcStakeSource.RequiredProperties) {
