...
/**
 * The CreateDestinationBankAccount model module.
 * @module model/CreateDestinationBankAccount
 */
class CreateDestinationBankAccount {
    /**
     * Constructs a new <code>CreateDestinationBankAccount</code>.
     ...
     * @alias module:model/CreateDestinationBankAccount
    ...
    constructor(account_alias, account_number, swift_code, currency, beneficiary_name, beneficiary_address, bank_name, bank_address) { 
        ...
        CreateDestinationBankAccount.initialize(this, account_alias, account_number, swift_code, currency, beneficiary_name, beneficiary_address, bank_name, bank_address);
    }
    ...
    /**
     * Constructs a <code>CreateDestinationBankAccount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDestinationBankAccount} obj Optional instance to populate.
     * @return {module:model/CreateDestinationBankAccount} The populated <code>CreateDestinationBankAccount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDestinationBankAccount();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDestinationBankAccount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDestinationBankAccount</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateDestinationBankAccount.RequiredProperties) {
...
CreateDestinationBankAccount.RequiredProperties = ["account_alias", "account_number", "swift_code", "currency", "beneficiary_name", "beneficiary_address", "bank_name", "bank_address"];

/**
 * The alias of the bank account.
 * @member {String} account_alias
 */
CreateDestinationBankAccount.prototype['account_alias'] = undefined;

/**
 * The bank account number.
 * @member {String} account_number
 */
CreateDestinationBankAccount.prototype['account_number'] = undefined;

/**
 * The SWIFT or BIC code of the bank.
 * @member {String} swift_code
 */
CreateDestinationBankAccount.prototype['swift_code'] = undefined;

/**
 * The currency of the bank account.
 * @member {String} currency
 */
CreateDestinationBankAccount.prototype['currency'] = undefined;

/**
 * The name of the account holder.
 * @member {String} beneficiary_name
 */
CreateDestinationBankAccount.prototype['beneficiary_name'] = undefined;

/**
 * The address of the account holder.
 * @member {String} beneficiary_address
 */
CreateDestinationBankAccount.prototype['beneficiary_address'] = undefined;

/**
 * The name of the bank.
 * @member {String} bank_name
 */
CreateDestinationBankAccount.prototype['bank_name'] = undefined;

/**
 * The address of the bank.
 * @member {String} bank_address
 */
CreateDestinationBankAccount.prototype['bank_address'] = undefined;

/**
 * The IBAN code of the bank account.
 * @member {String} iban_code
 */
CreateDestinationBankAccount.prototype['iban_code'] = undefined;

/**
 * The further credit of the bank account.
 * @member {String} further_credit
 */
CreateDestinationBankAccount.prototype['further_credit'] = undefined;
 ...
 */
CreateDestinationBankAccount.prototype['payment_method'] = undefined;

/**
 * @member {module:model/BankAccountHolderType} holder_type
 */
CreateDestinationBankAccount.prototype['holder_type'] = undefined;
 ...
 */
CreateDestinationBankAccount.prototype['contract_file_id'] = undefined;
...
export default CreateDestinationBankAccount;
