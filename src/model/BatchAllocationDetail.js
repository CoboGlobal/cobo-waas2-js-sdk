...
class BatchAllocationDetail {
     ...
     */
    constructor(batch_allocation_id, request_id) { 
     ...
     */
    static initialize(obj, batch_allocation_id, request_id) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('allocation_items')) {
                obj['allocation_items'] = ApiClient.convertToType(data['allocation_items'], [AllocationItem]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['allocation_items']) { // data not null
            ...
            for (const item of data['allocation_items']) {
