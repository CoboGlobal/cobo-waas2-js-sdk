    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('old_group_id')) {
                obj['old_group_id'] = ApiClient.convertToType(data['old_group_id'], 'String');
            }
            ...
            if (data.hasOwnProperty('old_threshold')) {
                obj['old_threshold'] = ApiClient.convertToType(data['old_threshold'], 'Number');
            }
            if (data.hasOwnProperty('new_threshold')) {
                obj['new_threshold'] = ApiClient.convertToType(data['new_threshold'], 'Number');
            }
            if (data.hasOwnProperty('new_node_ids')) {
                obj['new_node_ids'] = ApiClient.convertToType(data['new_node_ids'], ['String']);
            }
...
export default TSSKeyReshareRequest;
