 ...
 */
class TokenizationBurnTokenRequest {
    /**
     ...
     */
    constructor(source, burns, fee) { 
        TokenizationBurnTokenParams.initialize(this, source, burns);TokenizationAppInitiator.initialize(this);
     ...
     */
    static initialize(obj, source, burns, fee) { 
        obj['source'] = source;
        obj['burns'] = burns;
        obj['fee'] = fee;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of TokenizationBurnTokenRequest.RequiredProperties) {
...
export default TokenizationBurnTokenRequest;
