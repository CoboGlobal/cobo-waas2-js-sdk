...
class CreateStakeActivityRequest {
    ...
    constructor(poolId, amount, fee, extra) { 
        CreateStakeActivity.initialize(this, poolId, amount, fee, extra);ActivityInitiator.initialize(this);
        CreateStakeActivityRequest.initialize(this, poolId, amount, fee, extra);
    }
