...
class DestinationDetail {
     ...
     */
    constructor(destination_id, destination_type, destination_name, created_timestamp, updated_timestamp) { 
     ...
     */
    static initialize(obj, destination_id, destination_type, destination_name, created_timestamp, updated_timestamp) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of DestinationDetail.RequiredProperties) {
