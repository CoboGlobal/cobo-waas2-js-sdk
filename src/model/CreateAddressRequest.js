...
class CreateAddressRequest {
     ...
     * @param count {Number} The number of addresses to create. If you want to generate a tweaked address, `count` can only be `1`.
     */
 ...
 */
CreateAddressRequest.prototype['taproot_script_tree_hash'] = undefined;
