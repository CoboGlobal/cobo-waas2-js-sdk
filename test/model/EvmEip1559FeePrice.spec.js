...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.EvmEip1559FeePrice();
  });
  ...
  describe('EvmEip1559FeePrice', function() {
    it('should create an instance of EvmEip1559FeePrice', function() {
      // uncomment below and update the code to test EvmEip1559FeePrice
      //var instance = new CoboWaas2Api.EvmEip1559FeePrice();
      //expect(instance).to.be.a(CoboWaas2Api.EvmEip1559FeePrice);
    });
