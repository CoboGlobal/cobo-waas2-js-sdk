...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.EvmLegacyFeeBasePrice();
  });
  ...
  describe('EvmLegacyFeeBasePrice', function() {
    it('should create an instance of EvmLegacyFeeBasePrice', function() {
      ...
      //var instance = new CoboWaas2Api.EvmLegacyFeeBasePrice();
      //expect(instance).to.be.a(CoboWaas2Api.EvmLegacyFeeBasePrice);
    });
