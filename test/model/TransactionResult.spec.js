...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionResult();
  });
  ...
  describe('TransactionResult', function() {
    it('should create an instance of TransactionResult', function() {
      ...
      //var instance = new CoboWaas2JsApi.TransactionResult();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionResult);
    });
