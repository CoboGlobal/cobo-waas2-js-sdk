...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.BabylonStakeExtra();
  });
  ...
  describe('BabylonStakeExtra', function() {
    it('should create an instance of BabylonStakeExtra', function() {
      ...
      //var instance = new CoboWaas2JsApi.BabylonStakeExtra();
      //expect(instance).to.be.a(CoboWaas2JsApi.BabylonStakeExtra);
    });
