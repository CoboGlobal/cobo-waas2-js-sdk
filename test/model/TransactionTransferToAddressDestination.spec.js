...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionTransferToAddressDestination();
  });
  ...
  describe('TransactionTransferToAddressDestination', function() {
    it('should create an instance of TransactionTransferToAddressDestination', function() {
      // uncomment below and update the code to test TransactionTransferToAddressDestination
      //var instance = new CoboWaas2JsApi.TransactionTransferToAddressDestination();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionTransferToAddressDestination);
    });
