...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.BaseEstimateStakingFee();
  });
  ...
  describe('BaseEstimateStakingFee', function() {
    it('should create an instance of BaseEstimateStakingFee', function() {
      // uncomment below and update the code to test BaseEstimateStakingFee
