...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.RootPubkey();
  });
  ...
  describe('RootPubkey', function() {
    it('should create an instance of RootPubkey', function() {
      // uncomment below and update the code to test RootPubkey
      //var instance = new CoboWaas2JsApi.RootPubkey();
      //expect(instance).to.be.a(CoboWaas2JsApi.RootPubkey);
    });
