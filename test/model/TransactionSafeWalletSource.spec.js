...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionSafeWalletSource();
  });
  ...
  describe('TransactionSafeWalletSource', function() {
    it('should create an instance of TransactionSafeWalletSource', function() {
      // uncomment below and update the code to test TransactionSafeWalletSource
      //var instance = new CoboWaas2JsApi.TransactionSafeWalletSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionSafeWalletSource);
    });
