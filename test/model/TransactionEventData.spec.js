...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionEventData();
  });
  ...
  describe('TransactionEventData', function() {
    it('should create an instance of TransactionEventData', function() {
      // uncomment below and update the code to test TransactionEventData
      //var instance = new CoboWaas2JsApi.TransactionEventData();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionEventData);
    });
