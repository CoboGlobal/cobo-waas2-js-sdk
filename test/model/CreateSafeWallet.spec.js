...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.CreateSafeWallet();
  });
  ...
  describe('CreateSafeWallet', function() {
    it('should create an instance of CreateSafeWallet', function() {
      // uncomment below and update the code to test CreateSafeWallet
      //var instance = new CoboWaas2Api.CreateSafeWallet();
      //expect(instance).to.be.a(CoboWaas2Api.CreateSafeWallet);
    });
