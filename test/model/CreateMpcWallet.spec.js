...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.CreateMpcWallet();
  });
  ...
  describe('CreateMpcWallet', function() {
    it('should create an instance of CreateMpcWallet', function() {
      // uncomment below and update the code to test CreateMpcWallet
      //var instance = new CoboWaas2JsApi.CreateMpcWallet();
      //expect(instance).to.be.a(CoboWaas2JsApi.CreateMpcWallet);
    });
