...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.UtxoFeeSlow();
  });
  ...
  describe('UtxoFeeSlow', function() {
    it('should create an instance of UtxoFeeSlow', function() {
      // uncomment below and update the code to test UtxoFeeSlow
      //var instance = new CoboWaas2Api.UtxoFeeSlow();
      //expect(instance).to.be.a(CoboWaas2Api.UtxoFeeSlow);
    });
