...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.KeyHolder();
  });
  ...
  describe('KeyHolder', function() {
    it('should create an instance of KeyHolder', function() {
      // uncomment below and update the code to test KeyHolder
      //var instance = new CoboWaas2JsApi.KeyHolder();
      //expect(instance).to.be.a(CoboWaas2JsApi.KeyHolder);
    });
