...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.CreateStakeActivityRequest();
  });
  ...
  describe('CreateStakeActivityRequest', function() {
    it('should create an instance of CreateStakeActivityRequest', function() {
      // uncomment below and update the code to test CreateStakeActivityRequest
      //var instance = new CoboWaas2JsApi.CreateStakeActivityRequest();
      //expect(instance).to.be.a(CoboWaas2JsApi.CreateStakeActivityRequest);
    });
