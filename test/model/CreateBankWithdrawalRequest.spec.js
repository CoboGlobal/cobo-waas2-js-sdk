...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.CreateBankWithdrawalRequest();
  });
  ...
  describe('CreateBankWithdrawalRequest', function() {
    it('should create an instance of CreateBankWithdrawalRequest', function() {
      // uncomment below and update the code to test CreateBankWithdrawalRequest
      //var instance = new CoboWaas2.CreateBankWithdrawalRequest();
      //expect(instance).to.be.a(CoboWaas2.CreateBankWithdrawalRequest);
    });
