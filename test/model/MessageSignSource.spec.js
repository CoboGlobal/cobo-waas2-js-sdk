...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.MessageSignSource();
  });
  ...
  describe('MessageSignSource', function() {
    it('should create an instance of MessageSignSource', function() {
      ...
      //var instance = new CoboWaas2JsApi.MessageSignSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.MessageSignSource);
    });
