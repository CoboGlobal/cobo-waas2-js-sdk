...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionRbfSource();
  });
  ...
  describe('TransactionRbfSource', function() {
    it('should create an instance of TransactionRbfSource', function() {
      // uncomment below and update the code to test TransactionRbfSource
      //var instance = new CoboWaas2JsApi.TransactionRbfSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionRbfSource);
    });
