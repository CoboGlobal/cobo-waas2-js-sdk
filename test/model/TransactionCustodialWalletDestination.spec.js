...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionCustodialWalletDestination();
  });
  ...
  describe('TransactionCustodialWalletDestination', function() {
    it('should create an instance of TransactionCustodialWalletDestination', function() {
      // uncomment below and update the code to test TransactionCustodialWalletDestination
      //var instance = new CoboWaas2JsApi.TransactionCustodialWalletDestination();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionCustodialWalletDestination);
    });
