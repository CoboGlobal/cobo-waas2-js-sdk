...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.EvmEip1559TransactionFee();
  });
  ...
  describe('EvmEip1559TransactionFee', function() {
    it('should create an instance of EvmEip1559TransactionFee', function() {
      // uncomment below and update the code to test EvmEip1559TransactionFee
      //var instance = new CoboWaas2Api.EvmEip1559TransactionFee();
      //expect(instance).to.be.a(CoboWaas2Api.EvmEip1559TransactionFee);
    });
