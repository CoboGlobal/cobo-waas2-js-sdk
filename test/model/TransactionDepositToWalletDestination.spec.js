...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionDepositToWalletDestination();
  });
  ...
  describe('TransactionDepositToWalletDestination', function() {
    it('should create an instance of TransactionDepositToWalletDestination', function() {
      ...
      //var instance = new CoboWaas2JsApi.TransactionDepositToWalletDestination();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionDepositToWalletDestination);
    });
