...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.SafeWallet();
  });
  ...
  describe('SafeWallet', function() {
    it('should create an instance of SafeWallet', function() {
      // uncomment below and update the code to test SafeWallet
      //var instance = new CoboWaas2JsApi.SafeWallet();
      //expect(instance).to.be.a(CoboWaas2JsApi.SafeWallet);
    });
