...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentBulkSendEvent();
  });
  ...
  describe('PaymentBulkSendEvent', function() {
    it('should create an instance of PaymentBulkSendEvent', function() {
      // uncomment below and update the code to test PaymentBulkSendEvent
      //var instance = new CoboWaas2.PaymentBulkSendEvent();
      //expect(instance).to.be.a(CoboWaas2.PaymentBulkSendEvent);
    });
