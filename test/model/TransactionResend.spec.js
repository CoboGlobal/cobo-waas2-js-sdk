...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionResend();
  });
  ...
  describe('TransactionResend', function() {
    it('should create an instance of TransactionResend', function() {
      // uncomment below and update the code to test TransactionResend
