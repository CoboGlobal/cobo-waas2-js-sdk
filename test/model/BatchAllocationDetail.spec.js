...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.BatchAllocationDetail();
  });
  ...
  describe('BatchAllocationDetail', function() {
    it('should create an instance of BatchAllocationDetail', function() {
      // uncomment below and update the code to test BatchAllocationDetail
      //var instance = new CoboWaas2.BatchAllocationDetail();
      //expect(instance).to.be.a(CoboWaas2.BatchAllocationDetail);
    });
