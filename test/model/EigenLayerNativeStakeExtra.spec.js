...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.EigenLayerNativeStakeExtra();
  });
  ...
  describe('EigenLayerNativeStakeExtra', function() {
    it('should create an instance of EigenLayerNativeStakeExtra', function() {
      // uncomment below and update the code to test EigenLayerNativeStakeExtra
