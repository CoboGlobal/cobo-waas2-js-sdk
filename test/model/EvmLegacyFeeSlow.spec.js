...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.EvmLegacyFeeSlow();
  });
  ...
  describe('EvmLegacyFeeSlow', function() {
    it('should create an instance of EvmLegacyFeeSlow', function() {
      // uncomment below and update the code to test EvmLegacyFeeSlow
      //var instance = new CoboWaas2Api.EvmLegacyFeeSlow();
      //expect(instance).to.be.a(CoboWaas2Api.EvmLegacyFeeSlow);
    });
