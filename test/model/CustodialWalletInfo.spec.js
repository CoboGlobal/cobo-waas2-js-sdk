...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.CustodialWalletInfo();
  });
  ...
  describe('CustodialWalletInfo', function() {
    it('should create an instance of CustodialWalletInfo', function() {
      // uncomment below and update the code to test CustodialWalletInfo
      //var instance = new CoboWaas2JsApi.CustodialWalletInfo();
      //expect(instance).to.be.a(CoboWaas2JsApi.CustodialWalletInfo);
    });
