...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.CustodialWalletInfo();
  });
  ...
  describe('CustodialWalletInfo', function() {
    it('should create an instance of CustodialWalletInfo', function() {
      ...
      //var instance = new CoboWaas2Api.CustodialWalletInfo();
      //expect(instance).to.be.a(CoboWaas2Api.CustodialWalletInfo);
    });
