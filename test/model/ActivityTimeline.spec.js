...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.ActivityTimeline();
  });
  ...
  describe('ActivityTimeline', function() {
    it('should create an instance of ActivityTimeline', function() {
      // uncomment below and update the code to test ActivityTimeline
      //var instance = new CoboWaas2JsApi.ActivityTimeline();
      //expect(instance).to.be.a(CoboWaas2JsApi.ActivityTimeline);
    });
