...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.SignMessageSource();
  });
  ...
  describe('SignMessageSource', function() {
    it('should create an instance of SignMessageSource', function() {
      // uncomment below and update the code to test SignMessageSource
      //var instance = new CoboWaas2JsApi.SignMessageSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.SignMessageSource);
    });
