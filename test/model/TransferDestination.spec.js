...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.TransferDestination();
  });
  ...
  describe('TransferDestination', function() {
    it('should create an instance of TransferDestination', function() {
      ...
      //var instance = new CoboWaas2Api.TransferDestination();
      //expect(instance).to.be.a(CoboWaas2Api.TransferDestination);
    });
