...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionAddressDestination();
  });
  ...
  describe('TransactionAddressDestination', function() {
    it('should create an instance of TransactionAddressDestination', function() {
      // uncomment below and update the code to test TransactionAddressDestination
      //var instance = new CoboWaas2JsApi.TransactionAddressDestination();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionAddressDestination);
    });
