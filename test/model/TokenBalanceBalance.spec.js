...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.TokenBalanceBalance();
  });
  ...
  describe('TokenBalanceBalance', function() {
    it('should create an instance of TokenBalanceBalance', function() {
      ...
      //var instance = new CoboWaas2Api.TokenBalanceBalance();
      //expect(instance).to.be.a(CoboWaas2Api.TokenBalanceBalance);
    });
    ...
    it('should have the property staked (base name: "staked")', function() {
      // uncomment below and update the code to test the property staked
      //var instance = new CoboWaas2Api.TokenBalanceBalance();
      //expect(instance).to.be();
    });
