...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TokenBalanceBalance();
  });
  ...
  describe('TokenBalanceBalance', function() {
    it('should create an instance of TokenBalanceBalance', function() {
      ...
      //var instance = new CoboWaas2JsApi.TokenBalanceBalance();
      //expect(instance).to.be.a(CoboWaas2JsApi.TokenBalanceBalance);
    });
