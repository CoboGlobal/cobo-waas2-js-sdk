...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.EstimateFeeTransfer();
  });
  ...
  describe('EstimateFeeTransfer', function() {
    it('should create an instance of EstimateFeeTransfer', function() {
      // uncomment below and update the code to test EstimateFeeTransfer
