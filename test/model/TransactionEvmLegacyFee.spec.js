...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionEvmLegacyFee();
  });
  ...
  describe('TransactionEvmLegacyFee', function() {
    it('should create an instance of TransactionEvmLegacyFee', function() {
      // uncomment below and update the code to test TransactionEvmLegacyFee
