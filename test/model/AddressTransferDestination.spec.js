...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.AddressTransferDestination();
  });
  ...
  describe('AddressTransferDestination', function() {
    it('should create an instance of AddressTransferDestination', function() {
      ...
      //var instance = new CoboWaas2Api.AddressTransferDestination();
      //expect(instance).to.be.a(CoboWaas2Api.AddressTransferDestination);
    });
