...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.EstimateFeeContractCall();
  });
  ...
  describe('EstimateFeeContractCall', function() {
    it('should create an instance of EstimateFeeContractCall', function() {
      // uncomment below and update the code to test EstimateFeeContractCall
      //var instance = new CoboWaas2JsApi.EstimateFeeContractCall();
      //expect(instance).to.be.a(CoboWaas2JsApi.EstimateFeeContractCall);
    });
