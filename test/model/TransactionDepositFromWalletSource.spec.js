...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionDepositFromWalletSource();
  });
  ...
  describe('TransactionDepositFromWalletSource', function() {
    it('should create an instance of TransactionDepositFromWalletSource', function() {
      // uncomment below and update the code to test TransactionDepositFromWalletSource
      //var instance = new CoboWaas2JsApi.TransactionDepositFromWalletSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionDepositFromWalletSource);
    });
