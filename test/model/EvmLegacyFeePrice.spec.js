...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.EvmLegacyFeePrice();
  });
  ...
  describe('EvmLegacyFeePrice', function() {
    it('should create an instance of EvmLegacyFeePrice', function() {
      // uncomment below and update the code to test EvmLegacyFeePrice
      //var instance = new CoboWaas2JsApi.EvmLegacyFeePrice();
      //expect(instance).to.be.a(CoboWaas2JsApi.EvmLegacyFeePrice);
    });
