...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.ExchangeWalletTransactionAddress();
  });
  ...
  describe('ExchangeWalletTransactionAddress', function() {
    it('should create an instance of ExchangeWalletTransactionAddress', function() {
      // uncomment below and update the code to test ExchangeWalletTransactionAddress
      //var instance = new CoboWaas2JsApi.ExchangeWalletTransactionAddress();
      //expect(instance).to.be.a(CoboWaas2JsApi.ExchangeWalletTransactionAddress);
    });
