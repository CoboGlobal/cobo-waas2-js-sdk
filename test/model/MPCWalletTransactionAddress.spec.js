...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.MPCWalletTransactionAddress();
  });
  ...
  describe('MPCWalletTransactionAddress', function() {
    it('should create an instance of MPCWalletTransactionAddress', function() {
      // uncomment below and update the code to test MPCWalletTransactionAddress
      //var instance = new CoboWaas2JsApi.MPCWalletTransactionAddress();
      //expect(instance).to.be.a(CoboWaas2JsApi.MPCWalletTransactionAddress);
    });
