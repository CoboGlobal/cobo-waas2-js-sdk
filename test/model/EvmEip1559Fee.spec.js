...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.EvmEip1559Fee();
  });
  ...
  describe('EvmEip1559Fee', function() {
    it('should create an instance of EvmEip1559Fee', function() {
      // uncomment below and update the code to test EvmEip1559Fee
      //var instance = new CoboWaas2JsApi.EvmEip1559Fee();
      //expect(instance).to.be.a(CoboWaas2JsApi.EvmEip1559Fee);
    });
