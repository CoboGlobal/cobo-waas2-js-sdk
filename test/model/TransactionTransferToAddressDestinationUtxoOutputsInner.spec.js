...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionTransferToAddressDestinationUtxoOutputsInner();
  });
  ...
  describe('TransactionTransferToAddressDestinationUtxoOutputsInner', function() {
    it('should create an instance of TransactionTransferToAddressDestinationUtxoOutputsInner', function() {
      ...
      //var instance = new CoboWaas2JsApi.TransactionTransferToAddressDestinationUtxoOutputsInner();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionTransferToAddressDestinationUtxoOutputsInner);
    });
