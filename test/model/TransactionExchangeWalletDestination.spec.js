...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionExchangeWalletDestination();
  });
  ...
  describe('TransactionExchangeWalletDestination', function() {
    it('should create an instance of TransactionExchangeWalletDestination', function() {
      // uncomment below and update the code to test TransactionExchangeWalletDestination
      //var instance = new CoboWaas2JsApi.TransactionExchangeWalletDestination();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionExchangeWalletDestination);
    });
