...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.GetTokens200ResponseDataInner();
  });
  ...
  describe('GetTokens200ResponseDataInner', function() {
    it('should create an instance of GetTokens200ResponseDataInner', function() {
      // uncomment below and update the code to test GetTokens200ResponseDataInner
      //var instance = new CoboWaas2JsApi.GetTokens200ResponseDataInner();
      //expect(instance).to.be.a(CoboWaas2JsApi.GetTokens200ResponseDataInner);
    });
