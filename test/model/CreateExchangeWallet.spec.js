...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.CreateExchangeWallet();
  });
  ...
  describe('CreateExchangeWallet', function() {
    it('should create an instance of CreateExchangeWallet', function() {
      // uncomment below and update the code to test CreateExchangeWallet
      //var instance = new CoboWaas2JsApi.CreateExchangeWallet();
      //expect(instance).to.be.a(CoboWaas2JsApi.CreateExchangeWallet);
    });
