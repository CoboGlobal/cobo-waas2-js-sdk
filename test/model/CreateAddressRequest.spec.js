...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.CreateAddressRequest();
  });
  ...
  describe('CreateAddressRequest', function() {
    it('should create an instance of CreateAddressRequest', function() {
      ...
      //var instance = new CoboWaas2JsApi.CreateAddressRequest();
      //expect(instance).to.be.a(CoboWaas2JsApi.CreateAddressRequest);
    });
