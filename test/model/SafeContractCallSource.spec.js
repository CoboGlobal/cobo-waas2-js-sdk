...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.SafeContractCallSource();
  });
  ...
  describe('SafeContractCallSource', function() {
    it('should create an instance of SafeContractCallSource', function() {
      // uncomment below and update the code to test SafeContractCallSource
      //var instance = new CoboWaas2JsApi.SafeContractCallSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.SafeContractCallSource);
    });
