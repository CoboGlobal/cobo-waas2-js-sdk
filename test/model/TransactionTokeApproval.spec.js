...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.TransactionTokeApproval();
  });
  ...
  describe('TransactionTokeApproval', function() {
    it('should create an instance of TransactionTokeApproval', function() {
      // uncomment below and update the code to test TransactionTokeApproval
      //var instance = new CoboWaas2Api.TransactionTokeApproval();
      //expect(instance).to.be.a(CoboWaas2Api.TransactionTokeApproval);
    });
