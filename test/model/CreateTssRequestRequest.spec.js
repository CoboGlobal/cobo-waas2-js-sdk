...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.CreateTssRequestRequest();
  });
  ...
  describe('CreateTssRequestRequest', function() {
    it('should create an instance of CreateTssRequestRequest', function() {
      ...
      //var instance = new CoboWaas2Api.CreateTssRequestRequest();
      //expect(instance).to.be.a(CoboWaas2Api.CreateTssRequestRequest);
    });
    ...
    it('should have the property detailParams (base name: "detail_params")', function() {
      // uncomment below and update the code to test the property detailParams
      //var instance = new CoboWaas2Api.CreateTssRequestRequest();
      //expect(instance).to.be();
    });
