...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.SafeContractCallSourceAllOfDelegate();
  });
  ...
  describe('SafeContractCallSourceAllOfDelegate', function() {
    it('should create an instance of SafeContractCallSourceAllOfDelegate', function() {
      // uncomment below and update the code to test SafeContractCallSourceAllOfDelegate
      //var instance = new CoboWaas2JsApi.SafeContractCallSourceAllOfDelegate();
      //expect(instance).to.be.a(CoboWaas2JsApi.SafeContractCallSourceAllOfDelegate);
    });
