...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionDepositFromAddressSource();
  });
  ...
  describe('TransactionDepositFromAddressSource', function() {
    it('should create an instance of TransactionDepositFromAddressSource', function() {
      ...
      //var instance = new CoboWaas2JsApi.TransactionDepositFromAddressSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionDepositFromAddressSource);
    });
