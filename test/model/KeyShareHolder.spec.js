...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.KeyShareHolder();
  });
  ...
  describe('KeyShareHolder', function() {
    it('should create an instance of KeyShareHolder', function() {
      // uncomment below and update the code to test KeyShareHolder
      //var instance = new CoboWaas2JsApi.KeyShareHolder();
      //expect(instance).to.be.a(CoboWaas2JsApi.KeyShareHolder);
    });
