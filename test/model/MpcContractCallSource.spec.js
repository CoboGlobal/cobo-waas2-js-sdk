...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.MpcContractCallSource();
  });
  ...
  describe('MpcContractCallSource', function() {
    it('should create an instance of MpcContractCallSource', function() {
      // uncomment below and update the code to test MpcContractCallSource
      //var instance = new CoboWaas2JsApi.MpcContractCallSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.MpcContractCallSource);
    });
