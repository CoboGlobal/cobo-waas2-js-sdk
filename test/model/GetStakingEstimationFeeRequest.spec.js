...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.GetStakingEstimationFeeRequest();
  });
  ...
  describe('GetStakingEstimationFeeRequest', function() {
    it('should create an instance of GetStakingEstimationFeeRequest', function() {
      // uncomment below and update the code to test GetStakingEstimationFeeRequest
      //var instance = new CoboWaas2JsApi.GetStakingEstimationFeeRequest();
      //expect(instance).to.be.a(CoboWaas2JsApi.GetStakingEstimationFeeRequest);
    });
