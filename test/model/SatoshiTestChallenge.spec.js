...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.SatoshiTestChallenge();
  });
  ...
  describe('SatoshiTestChallenge', function() {
    it('should create an instance of SatoshiTestChallenge', function() {
      // uncomment below and update the code to test SatoshiTestChallenge
      //var instance = new CoboWaas2.SatoshiTestChallenge();
      //expect(instance).to.be.a(CoboWaas2.SatoshiTestChallenge);
    });
