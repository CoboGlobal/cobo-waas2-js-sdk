...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.UtxoFeePrice();
  });
  ...
  describe('UtxoFeePrice', function() {
    it('should create an instance of UtxoFeePrice', function() {
      // uncomment below and update the code to test UtxoFeePrice
      //var instance = new CoboWaas2JsApi.UtxoFeePrice();
      //expect(instance).to.be.a(CoboWaas2JsApi.UtxoFeePrice);
    });
