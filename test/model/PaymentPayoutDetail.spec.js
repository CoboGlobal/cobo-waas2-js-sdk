...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentPayoutDetail();
  });
  ...
  describe('PaymentPayoutDetail', function() {
    it('should create an instance of PaymentPayoutDetail', function() {
      // uncomment below and update the code to test PaymentPayoutDetail
      //var instance = new CoboWaas2.PaymentPayoutDetail();
      //expect(instance).to.be.a(CoboWaas2.PaymentPayoutDetail);
    });
