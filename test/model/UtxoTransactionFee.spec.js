...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.UtxoTransactionFee();
  });
  ...
  describe('UtxoTransactionFee', function() {
    it('should create an instance of UtxoTransactionFee', function() {
      // uncomment below and update the code to test UtxoTransactionFee
      //var instance = new CoboWaas2Api.UtxoTransactionFee();
      //expect(instance).to.be.a(CoboWaas2Api.UtxoTransactionFee);
    });
