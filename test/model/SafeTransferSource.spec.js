...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.SafeTransferSource();
  });
  ...
  describe('SafeTransferSource', function() {
    it('should create an instance of SafeTransferSource', function() {
      ...
      //var instance = new CoboWaas2JsApi.SafeTransferSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.SafeTransferSource);
    });
