...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionTransferToWalletDestination();
  });
  ...
  describe('TransactionTransferToWalletDestination', function() {
    it('should create an instance of TransactionTransferToWalletDestination', function() {
      // uncomment below and update the code to test TransactionTransferToWalletDestination
      //var instance = new CoboWaas2JsApi.TransactionTransferToWalletDestination();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionTransferToWalletDestination);
    });
