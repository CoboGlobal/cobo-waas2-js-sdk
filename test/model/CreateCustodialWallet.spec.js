...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.CreateCustodialWallet();
  });
  ...
  describe('CreateCustodialWallet', function() {
    it('should create an instance of CreateCustodialWallet', function() {
      ...
      //var instance = new CoboWaas2Api.CreateCustodialWallet();
      //expect(instance).to.be.a(CoboWaas2Api.CreateCustodialWallet);
    });
