...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionExchangeWalletSource();
  });
  ...
  describe('TransactionExchangeWalletSource', function() {
    it('should create an instance of TransactionExchangeWalletSource', function() {
      // uncomment below and update the code to test TransactionExchangeWalletSource
      //var instance = new CoboWaas2JsApi.TransactionExchangeWalletSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionExchangeWalletSource);
    });
