...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.SafeTransactionAddressAllOfDelegate();
  });
  ...
  describe('SafeTransactionAddressAllOfDelegate', function() {
    it('should create an instance of SafeTransactionAddressAllOfDelegate', function() {
      // uncomment below and update the code to test SafeTransactionAddressAllOfDelegate
      //var instance = new CoboWaas2JsApi.SafeTransactionAddressAllOfDelegate();
      //expect(instance).to.be.a(CoboWaas2JsApi.SafeTransactionAddressAllOfDelegate);
    });
