...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.ExchangeTransferSource();
  });
  ...
  describe('ExchangeTransferSource', function() {
    it('should create an instance of ExchangeTransferSource', function() {
      // uncomment below and update the code to test ExchangeTransferSource
      //var instance = new CoboWaas2Api.ExchangeTransferSource();
      //expect(instance).to.be.a(CoboWaas2Api.ExchangeTransferSource);
    });
