...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.RefreshTokenRequest();
  });
  ...
  describe('RefreshTokenRequest', function() {
    it('should create an instance of RefreshTokenRequest', function() {
      ...
      //var instance = new CoboWaas2JsApi.RefreshTokenRequest();
      //expect(instance).to.be.a(CoboWaas2JsApi.RefreshTokenRequest);
    });
