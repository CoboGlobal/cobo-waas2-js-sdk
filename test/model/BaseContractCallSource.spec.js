...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.BaseContractCallSource();
  });
  ...
  describe('BaseContractCallSource', function() {
    it('should create an instance of BaseContractCallSource', function() {
      // uncomment below and update the code to test BaseContractCallSource
      //var instance = new CoboWaas2JsApi.BaseContractCallSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.BaseContractCallSource);
    });
