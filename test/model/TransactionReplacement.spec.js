...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionReplacement();
  });
  ...
  describe('TransactionReplacement', function() {
    it('should create an instance of TransactionReplacement', function() {
      // uncomment below and update the code to test TransactionReplacement
