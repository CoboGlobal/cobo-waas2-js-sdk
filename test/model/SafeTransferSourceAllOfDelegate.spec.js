...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.SafeTransferSourceAllOfDelegate();
  });
  ...
  describe('SafeTransferSourceAllOfDelegate', function() {
    it('should create an instance of SafeTransferSourceAllOfDelegate', function() {
      ...
      //var instance = new CoboWaas2Api.SafeTransferSourceAllOfDelegate();
      //expect(instance).to.be.a(CoboWaas2Api.SafeTransferSourceAllOfDelegate);
    });
