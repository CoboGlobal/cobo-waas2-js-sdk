...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.SafeTransferSourceAllOfDelegate();
  });
  ...
  describe('SafeTransferSourceAllOfDelegate', function() {
    it('should create an instance of SafeTransferSourceAllOfDelegate', function() {
      // uncomment below and update the code to test SafeTransferSourceAllOfDelegate
      //var instance = new CoboWaas2JsApi.SafeTransferSourceAllOfDelegate();
      //expect(instance).to.be.a(CoboWaas2JsApi.SafeTransferSourceAllOfDelegate);
    });
