...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.EvmContractCallDestination();
  });
  ...
  describe('EvmContractCallDestination', function() {
    it('should create an instance of EvmContractCallDestination', function() {
      // uncomment below and update the code to test EvmContractCallDestination
