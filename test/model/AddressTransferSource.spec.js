...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.AddressTransferSource();
  });
  ...
  describe('AddressTransferSource', function() {
    it('should create an instance of AddressTransferSource', function() {
      ...
      //var instance = new CoboWaas2Api.AddressTransferSource();
      //expect(instance).to.be.a(CoboWaas2Api.AddressTransferSource);
    });
