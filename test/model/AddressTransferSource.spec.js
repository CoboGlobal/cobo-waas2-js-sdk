...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.AddressTransferSource();
  });
  ...
  describe('AddressTransferSource', function() {
    it('should create an instance of AddressTransferSource', function() {
      // uncomment below and update the code to test AddressTransferSource
      //var instance = new CoboWaas2JsApi.AddressTransferSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.AddressTransferSource);
    });
