...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionSmartContractSafeWalletSource();
  });
  ...
  describe('TransactionSmartContractSafeWalletSource', function() {
    it('should create an instance of TransactionSmartContractSafeWalletSource', function() {
      // uncomment below and update the code to test TransactionSmartContractSafeWalletSource
      //var instance = new CoboWaas2JsApi.TransactionSmartContractSafeWalletSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionSmartContractSafeWalletSource);
    });
