...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TokenizationIssueTokenParamsTokenParams();
  });
  ...
  describe('TokenizationIssueTokenParamsTokenParams', function() {
    it('should create an instance of TokenizationIssueTokenParamsTokenParams', function() {
      // uncomment below and update the code to test TokenizationIssueTokenParamsTokenParams
      //var instance = new CoboWaas2.TokenizationIssueTokenParamsTokenParams();
      //expect(instance).to.be.a(CoboWaas2.TokenizationIssueTokenParamsTokenParams);
    });
