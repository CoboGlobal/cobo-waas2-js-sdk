...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.MpcMessageSignSource();
  });
  ...
  describe('MpcMessageSignSource', function() {
    it('should create an instance of MpcMessageSignSource', function() {
      // uncomment below and update the code to test MpcMessageSignSource
      //var instance = new CoboWaas2JsApi.MpcMessageSignSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.MpcMessageSignSource);
    });
