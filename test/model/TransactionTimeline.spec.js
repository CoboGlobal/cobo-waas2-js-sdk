...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.TransactionTimeline();
  });
  ...
  describe('TransactionTimeline', function() {
    it('should create an instance of TransactionTimeline', function() {
      ...
      //var instance = new CoboWaas2Api.TransactionTimeline();
      //expect(instance).to.be.a(CoboWaas2Api.TransactionTimeline);
    });
