...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.CoboSafeDelegate();
  });
  ...
  describe('CoboSafeDelegate', function() {
    it('should create an instance of CoboSafeDelegate', function() {
      // uncomment below and update the code to test CoboSafeDelegate
