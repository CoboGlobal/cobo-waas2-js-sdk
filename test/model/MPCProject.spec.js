...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.MPCProject();
  });
  ...
  describe('MPCProject', function() {
    it('should create an instance of MPCProject', function() {
      // uncomment below and update the code to test MPCProject
      //var instance = new CoboWaas2Api.MPCProject();
      //expect(instance).to.be.a(CoboWaas2Api.MPCProject);
    });
