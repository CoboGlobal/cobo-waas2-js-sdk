...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.BaseStakeExtra();
  });
  ...
  describe('BaseStakeExtra', function() {
    it('should create an instance of BaseStakeExtra', function() {
      // uncomment below and update the code to test BaseStakeExtra
