...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.EvmLegacyTransactionFee();
  });
  ...
  describe('EvmLegacyTransactionFee', function() {
    it('should create an instance of EvmLegacyTransactionFee', function() {
      // uncomment below and update the code to test EvmLegacyTransactionFee
      //var instance = new CoboWaas2Api.EvmLegacyTransactionFee();
      //expect(instance).to.be.a(CoboWaas2Api.EvmLegacyTransactionFee);
    });
