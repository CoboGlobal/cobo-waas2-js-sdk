...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentTransactionEventData();
  });
  ...
  describe('PaymentTransactionEventData', function() {
    it('should create an instance of PaymentTransactionEventData', function() {
      // uncomment below and update the code to test PaymentTransactionEventData
      //var instance = new CoboWaas2.PaymentTransactionEventData();
      //expect(instance).to.be.a(CoboWaas2.PaymentTransactionEventData);
    });
