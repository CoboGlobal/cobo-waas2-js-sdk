...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.CreateKeyGroupRequest();
  });
  ...
  describe('CreateKeyGroupRequest', function() {
    it('should create an instance of CreateKeyGroupRequest', function() {
      // uncomment below and update the code to test CreateKeyGroupRequest
      //var instance = new CoboWaas2JsApi.CreateKeyGroupRequest();
      //expect(instance).to.be.a(CoboWaas2JsApi.CreateKeyGroupRequest);
    });
