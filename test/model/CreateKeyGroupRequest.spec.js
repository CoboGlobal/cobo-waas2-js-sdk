...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.CreateKeyGroupRequest();
  });
  ...
  describe('CreateKeyGroupRequest', function() {
    it('should create an instance of CreateKeyGroupRequest', function() {
      ...
      //var instance = new CoboWaas2Api.CreateKeyGroupRequest();
      //expect(instance).to.be.a(CoboWaas2Api.CreateKeyGroupRequest);
    });
