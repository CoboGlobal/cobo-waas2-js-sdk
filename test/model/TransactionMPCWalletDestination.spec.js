...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionMPCWalletDestination();
  });
  ...
  describe('TransactionMPCWalletDestination', function() {
    it('should create an instance of TransactionMPCWalletDestination', function() {
      // uncomment below and update the code to test TransactionMPCWalletDestination
      //var instance = new CoboWaas2JsApi.TransactionMPCWalletDestination();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionMPCWalletDestination);
    });
