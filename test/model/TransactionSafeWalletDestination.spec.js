...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionSafeWalletDestination();
  });
  ...
  describe('TransactionSafeWalletDestination', function() {
    it('should create an instance of TransactionSafeWalletDestination', function() {
      // uncomment below and update the code to test TransactionSafeWalletDestination
      //var instance = new CoboWaas2JsApi.TransactionSafeWalletDestination();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionSafeWalletDestination);
    });
