...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.LockSpendableListRequestSpendablesInner();
  });
  ...
  describe('LockSpendableListRequestSpendablesInner', function() {
    it('should create an instance of LockSpendableListRequestSpendablesInner', function() {
      // uncomment below and update the code to test LockSpendableListRequestSpendablesInner
      //var instance = new CoboWaas2JsApi.LockSpendableListRequestSpendablesInner();
      //expect(instance).to.be.a(CoboWaas2JsApi.LockSpendableListRequestSpendablesInner);
    });
