...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.FeeData();
  });
  ...
  describe('FeeData', function() {
    it('should create an instance of FeeData', function() {
      // uncomment below and update the code to test FeeData
      //var instance = new CoboWaas2Api.FeeData();
      //expect(instance).to.be.a(CoboWaas2Api.FeeData);
    });
