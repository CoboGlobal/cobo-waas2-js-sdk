...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.PoolDetailsAllOfValidatorsInfo();
  });
  ...
  describe('PoolDetailsAllOfValidatorsInfo', function() {
    it('should create an instance of PoolDetailsAllOfValidatorsInfo', function() {
      // uncomment below and update the code to test PoolDetailsAllOfValidatorsInfo
