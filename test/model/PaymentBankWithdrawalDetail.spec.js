...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentBankWithdrawalDetail();
  });
  ...
  describe('PaymentBankWithdrawalDetail', function() {
    it('should create an instance of PaymentBankWithdrawalDetail', function() {
      // uncomment below and update the code to test PaymentBankWithdrawalDetail
      //var instance = new CoboWaas2.PaymentBankWithdrawalDetail();
      //expect(instance).to.be.a(CoboWaas2.PaymentBankWithdrawalDetail);
    });
