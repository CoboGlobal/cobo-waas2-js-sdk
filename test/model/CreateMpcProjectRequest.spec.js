...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.CreateMpcProjectRequest();
  });
  ...
  describe('CreateMpcProjectRequest', function() {
    it('should create an instance of CreateMpcProjectRequest', function() {
      // uncomment below and update the code to test CreateMpcProjectRequest
      //var instance = new CoboWaas2Api.CreateMpcProjectRequest();
      //expect(instance).to.be.a(CoboWaas2Api.CreateMpcProjectRequest);
    });
