...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.SafeWalletAllOfInitiator();
  });
  ...
  describe('SafeWalletAllOfInitiator', function() {
    it('should create an instance of SafeWalletAllOfInitiator', function() {
      ...
      //var instance = new CoboWaas2Api.SafeWalletAllOfInitiator();
      //expect(instance).to.be.a(CoboWaas2Api.SafeWalletAllOfInitiator);
    });
