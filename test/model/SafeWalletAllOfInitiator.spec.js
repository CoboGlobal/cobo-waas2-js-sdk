...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.SafeWalletAllOfInitiator();
  });
  ...
  describe('SafeWalletAllOfInitiator', function() {
    it('should create an instance of SafeWalletAllOfInitiator', function() {
      // uncomment below and update the code to test SafeWalletAllOfInitiator
      //var instance = new CoboWaas2JsApi.SafeWalletAllOfInitiator();
      //expect(instance).to.be.a(CoboWaas2JsApi.SafeWalletAllOfInitiator);
    });
