...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.CreateSafeWalletAllOfInitiator();
  });
  ...
  describe('CreateSafeWalletAllOfInitiator', function() {
    it('should create an instance of CreateSafeWalletAllOfInitiator', function() {
      // uncomment below and update the code to test CreateSafeWalletAllOfInitiator
      //var instance = new CoboWaas2JsApi.CreateSafeWalletAllOfInitiator();
      //expect(instance).to.be.a(CoboWaas2JsApi.CreateSafeWalletAllOfInitiator);
    });
