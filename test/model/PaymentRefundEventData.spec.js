...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentRefundEventData();
  });
  ...
  describe('PaymentRefundEventData', function() {
    it('should create an instance of PaymentRefundEventData', function() {
      // uncomment below and update the code to test PaymentRefundEventData
      //var instance = new CoboWaas2.PaymentRefundEventData();
      //expect(instance).to.be.a(CoboWaas2.PaymentRefundEventData);
    });
