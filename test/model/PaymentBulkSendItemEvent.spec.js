...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentBulkSendItemEvent();
  });
  ...
  describe('PaymentBulkSendItemEvent', function() {
    it('should create an instance of PaymentBulkSendItemEvent', function() {
      // uncomment below and update the code to test PaymentBulkSendItemEvent
      //var instance = new CoboWaas2.PaymentBulkSendItemEvent();
      //expect(instance).to.be.a(CoboWaas2.PaymentBulkSendItemEvent);
    });
