...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.SmartContractInitiator();
  });
  ...
  describe('SmartContractInitiator', function() {
    it('should create an instance of SmartContractInitiator', function() {
      // uncomment below and update the code to test SmartContractInitiator
