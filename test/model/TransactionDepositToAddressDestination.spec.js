...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionDepositToAddressDestination();
  });
  ...
  describe('TransactionDepositToAddressDestination', function() {
    it('should create an instance of TransactionDepositToAddressDestination', function() {
      // uncomment below and update the code to test TransactionDepositToAddressDestination
      //var instance = new CoboWaas2JsApi.TransactionDepositToAddressDestination();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionDepositToAddressDestination);
    });
