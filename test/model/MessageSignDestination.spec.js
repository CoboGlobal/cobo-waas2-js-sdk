...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.MessageSignDestination();
  });
  ...
  describe('MessageSignDestination', function() {
    it('should create an instance of MessageSignDestination', function() {
      // uncomment below and update the code to test MessageSignDestination
      //var instance = new CoboWaas2JsApi.MessageSignDestination();
      //expect(instance).to.be.a(CoboWaas2JsApi.MessageSignDestination);
    });
