...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.ExtendedTokenInfo();
  });
  ...
  describe('ExtendedTokenInfo', function() {
    it('should create an instance of ExtendedTokenInfo', function() {
      ...
      //var instance = new CoboWaas2JsApi.ExtendedTokenInfo();
      //expect(instance).to.be.a(CoboWaas2JsApi.ExtendedTokenInfo);
    });
