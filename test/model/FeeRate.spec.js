...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.FeeRate();
  });
  ...
  describe('FeeRate', function() {
    it('should create an instance of FeeRate', function() {
      // uncomment below and update the code to test FeeRate
      //var instance = new CoboWaas2JsApi.FeeRate();
      //expect(instance).to.be.a(CoboWaas2JsApi.FeeRate);
    });
