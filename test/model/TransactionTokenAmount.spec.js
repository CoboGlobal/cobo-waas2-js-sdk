...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionTokenAmount();
  });
  ...
  describe('TransactionTokenAmount', function() {
    it('should create an instance of TransactionTokenAmount', function() {
      // uncomment below and update the code to test TransactionTokenAmount
