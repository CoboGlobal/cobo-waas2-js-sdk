...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentBankWithdrawalEvent();
  });
  ...
  describe('PaymentBankWithdrawalEvent', function() {
    it('should create an instance of PaymentBankWithdrawalEvent', function() {
      // uncomment below and update the code to test PaymentBankWithdrawalEvent
      //var instance = new CoboWaas2.PaymentBankWithdrawalEvent();
      //expect(instance).to.be.a(CoboWaas2.PaymentBankWithdrawalEvent);
    });
