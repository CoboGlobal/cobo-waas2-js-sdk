...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentBulkSendItem();
  });
  ...
  describe('PaymentBulkSendItem', function() {
    it('should create an instance of PaymentBulkSendItem', function() {
      // uncomment below and update the code to test PaymentBulkSendItem
      //var instance = new CoboWaas2.PaymentBulkSendItem();
      //expect(instance).to.be.a(CoboWaas2.PaymentBulkSendItem);
    });
