...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.UtxoFeeBasePrice();
  });
  ...
  describe('UtxoFeeBasePrice', function() {
    it('should create an instance of UtxoFeeBasePrice', function() {
      // uncomment below and update the code to test UtxoFeeBasePrice
      //var instance = new CoboWaas2Api.UtxoFeeBasePrice();
      //expect(instance).to.be.a(CoboWaas2Api.UtxoFeeBasePrice);
    });
