...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.SmartContractWalletInfo();
  });
  ...
  describe('SmartContractWalletInfo', function() {
    it('should create an instance of SmartContractWalletInfo', function() {
      ...
      //var instance = new CoboWaas2Api.SmartContractWalletInfo();
      //expect(instance).to.be.a(CoboWaas2Api.SmartContractWalletInfo);
    });
