...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.TransactionToken();
  });
  ...
  describe('TransactionToken', function() {
    it('should create an instance of TransactionToken', function() {
      // uncomment below and update the code to test TransactionToken
      //var instance = new CoboWaas2JsApi.TransactionToken();
      //expect(instance).to.be.a(CoboWaas2JsApi.TransactionToken);
    });
