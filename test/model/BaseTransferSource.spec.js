...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.BaseTransferSource();
  });
  ...
  describe('BaseTransferSource', function() {
    it('should create an instance of BaseTransferSource', function() {
      // uncomment below and update the code to test BaseTransferSource
      //var instance = new CoboWaas2JsApi.BaseTransferSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.BaseTransferSource);
    });
