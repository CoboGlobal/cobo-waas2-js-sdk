...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.ExchangeTransferDestination();
  });
  ...
  describe('ExchangeTransferDestination', function() {
    it('should create an instance of ExchangeTransferDestination', function() {
      // uncomment below and update the code to test ExchangeTransferDestination
      //var instance = new CoboWaas2Api.ExchangeTransferDestination();
      //expect(instance).to.be.a(CoboWaas2Api.ExchangeTransferDestination);
    });
