...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.CreateOrderLinkRequest();
  });
  ...
  describe('CreateOrderLinkRequest', function() {
    it('should create an instance of CreateOrderLinkRequest', function() {
      // uncomment below and update the code to test CreateOrderLinkRequest
