...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2JsApi.StakingSource();
  });
  ...
  describe('StakingSource', function() {
    it('should create an instance of StakingSource', function() {
      // uncomment below and update the code to test StakingSource
      //var instance = new CoboWaas2JsApi.StakingSource();
      //expect(instance).to.be.a(CoboWaas2JsApi.StakingSource);
    });
