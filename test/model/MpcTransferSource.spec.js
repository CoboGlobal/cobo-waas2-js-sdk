...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2Api.MpcTransferSource();
  });
  ...
  describe('MpcTransferSource', function() {
    it('should create an instance of MpcTransferSource', function() {
      // uncomment below and update the code to test MpcTransferSource
      //var instance = new CoboWaas2Api.MpcTransferSource();
      //expect(instance).to.be.a(CoboWaas2Api.MpcTransferSource);
    });
