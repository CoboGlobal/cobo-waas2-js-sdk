...
**failed_reason** | **String** | The reason why the refund failed. | [optional] 
...
* `PaymentBankWithdrawal` (value: `"PaymentBankWithdrawal"`)

* `PaymentBulkSend` (value: `"PaymentBulkSend"`)

* `PaymentBulkSendItem` (value: `"PaymentBulkSendItem"`)
