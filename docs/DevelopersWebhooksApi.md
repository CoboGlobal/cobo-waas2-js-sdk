...
> Endpoint getWebhookEndpointById(endpoint_id)
...
const opts = {
  ...
  'event_type': new CoboWaas2JsApi.WebhookEventType(), // WebhookEventType | 
...
> Endpoint updateWebhookEndpointById(endpoint_id, opts)
